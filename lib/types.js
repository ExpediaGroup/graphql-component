...
const namespaceDirectives = function (component, document) {
  const directives = component._directives || {};
...
const getImportedTypes = function (component, excludes) {
  const types = component._types.map((type) => namespaceDirectives(component, parse(type)));
