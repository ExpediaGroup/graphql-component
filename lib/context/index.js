...
const createContext = function (root, ctxConfig) {
  return async function (context) {
    const ctx = {};

    for (const { component } of root.imports) {
      Object.assign(ctx, await component._context(context));
    }
    ...
    if (ctxConfig) {
      ...
      Object.assign(ctx[ctxConfig.namespace], await ctxConfig.factory.call(root, context));
    }
